    ...
    async def generate_response(
        ...
        if is_audio:
            system_prompt += (
                ...
                "- Números por extenso quando soar mais natural falado "
                "(ex: 'mais de trinta mil planos' em vez de '30.000+').\n"
                "- Valores monetários por extenso quando aparecerem "
                "(ex: 'mil e novecentos dólares' em vez de 'US$ 1.900').\n"
                "- NÃO inclua URLs, links ou e-mails — ficam impronunciáveis. "
                "Se precisar enviar link, diga 'vou te enviar por escrito em seguida'.\n"
